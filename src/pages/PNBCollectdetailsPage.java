...
public class PNBCollectdetailsPage extends AppiumWrappers{
	
	public PNBCollectdetailsPage SelectTransferToAccount(String Bankname)
	{
		try {
	...
	public PNBCollectdetailsPage EnterVirtualAddress(String Vaddress)
	{
		try {
	...
	public PNBCollectdetailsPage EnterAmount(String Amount)
	{
		try {
	...
	public PNBCollectdetailsPage clickstartdate()
	{
		try {
	...
	public PNBCollectdetailsPage ClickDone()
	{
		try {
			hideKeyboard();
	...
	public PNBCollectdetailsPage EnterRemarks(String remarks)
	{
		try {
...
public 	PNBCollectdetailsPageConfirmation ClickSubmit()
{
	try {
	...
	return new PNBCollectdetailsPageConfirmation();
}
