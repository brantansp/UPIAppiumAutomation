...
public class PNBChangePINPage extends GenericWrappers{
	...
	public PNBChangePINPage ClickAlertOkforFailure()
	{
		try {
	...
	public PNBChangePINPage Enteroldpin(String oldpin)
	{
		try {
	...
	public PNBChangePINPage EnterNewpin(String oldpin)
	{
		try {
	...
	public PNBChangePINPage EnterConfirmNewPin(String oldpin)
	{
		try {
	...
	public PNBChangePINPage verifyalerttext(String text)
	{
		try {
	...
	public PNBChangePINPage ClickSubmit()
	{
		try {
			hideKeyboard();
