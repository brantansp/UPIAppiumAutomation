...
public class UBIAddVirtualAddressPage extends AppiumWrappers {
	public UBIAddVirtualAddressPage pagetitle(String txt)
	{
		try {
	...
	public UBIAddVirtualAddressPage SelectAccount(String txt)
	{
		try {
	...
	public UBIAddVirtualAddressPage enterVirtualAddress(String txt)
	{
		try {			
	...
	public UBIAddVirtualAddressPage selectFrequency()
	{
		try {			
	...
	public UBIAddVirtualAddressPage clickSubmit()
	{
		try {
	...
	public UBIAddVirtualAddressPage verifyAlertText(String txt)
	{
		try {
	...
	public UBIAddVirtualAddressPage ClickAlertOkforFailure()
	{
		try {
