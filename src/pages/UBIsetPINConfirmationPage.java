...
public class UBIsetPINConfirmationPage extends GenericWrappers{

	public UBIsetPINConfirmationPage enterOTP()
	{
		try {
			sleep(15000);
	...
	public UBIsetPINConfirmationPage enterSetPIN(String newpin)
	{
		try {
	...
	public UBIsetPINConfirmationPage enterSetPINConfirm(String confirmpin)
	{
		try {
	...
	public UBIsetPINConfirmationPage enterDebitcardnumber(String cardnumber)
	{
		try {
	...
	public UBIsetPINConfirmationPage enterexpirydate(String month,String year)
	{
		try {
	...
	public UBIsetPINConfirmationPage ClickSubmit()
	{
		try {
	...
	public UBIHomePage ClickAlertOkforFailure()
	{
		try {
	...
	public UBIsetPINConfirmationPage verifyalerttext(String text)
	{
		try {
