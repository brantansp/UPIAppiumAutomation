...
public class Reporter extends  AppiumWrappers{
	...
	public static void reportStepWOsnap(String desc, String status) {
	...
	public static void startTestCase(String name,String Description){
